...
<div>
    <Navbar>
        ...
        <v-container fluid>
            <v-data-table :headers="headers" :items="roles" sort-by="calories" class="elevation-1" :search="search">
                <template v-slot:top>
                    <v-toolbar flat>
...
export default {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            roleService.delete(this.editedItem.id)
                .then((result) => {
        ...
        save() {
            if (this.editedIndex > -1) {
                roleService.update(this.editedItem)
                    .then((result) => {
                ...
                roleService.add(this.editedItem)
                    .then((result) => {
