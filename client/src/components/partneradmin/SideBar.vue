    ...
    >
      ...
      <v-list>
        <v-list-item-group v-model="selectedItem" color="primary">
          <v-list-item
            @click="navigateTo('/partneradmin/partner-admin-home')"
            class="white--text"
          >
            <v-list-item-icon>
                      ...
                      <v-card class="pa-3">
                        ...
                        >
                          ...
                          <div>
                            <v-btn
                              ...
                              @click="newMsg = !newMsg"
                            >
                              <v-icon class="mdi-light">mdi-plus</v-icon>
                            </v-btn>
                            <div v-if="newMsg">
                              <v-text-field
                                label="adresse de messagérie"
                                v-model="userAccount"
                              >
                              </v-text-field>
                              <v-btn
                                icon
                                @click="chatWith(userAccount)"
                              >
                                <v-icon>mdi-chat-outline</v-icon>
                              </v-btn>
                            </div>
                          ...
                          >
                            ...
                            <div class="d-flex justify-space-between"
                              style="cursor: pointer;"  @click="chatWith(client)">
                        ...
                        >
                          <v-toolbar dense flat>
                            <v-toolbar-title>{{ searchUser }}</v-toolbar-title>
                            <v-spacer></v-spacer>
                            <v-btn icon
...
export default {
  methods: {
    ...
    chatWith (userAccount) {
      this.conversationList = false
      this.messageBox = true
      this.searchUser = userAccount
      this.userAccount = ''
    },
