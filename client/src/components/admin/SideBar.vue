    ...
    >
      <template v-slot:prepend>
        <v-list-item two-line>
          ...
          <v-list-item-content>
            <v-list-item-title class="white--text">Ressources</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </template>
      <v-divider></v-divider>
      <v-list>
        <v-list-item-group v-model="selectedItem" color="primary">
          ...
          >
            <v-list-item-icon>
              <v-icon class="white--text">mdi-stack-exchange</v-icon>
            </v-list-item-icon>
            ...
            >
              <template v-slot:activator="{ on, attrs }">
                ...
                >
                  ...
                  <v-list-item-content>
                   <v-list-item-title class="white--text">Messagérie</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </template>
